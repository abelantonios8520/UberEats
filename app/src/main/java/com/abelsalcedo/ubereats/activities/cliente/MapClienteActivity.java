...
import com.abelsalcedo.ubereats.activities.splash;
import com.abelsalcedo.ubereats.includes.MyToolbar;
import com.abelsalcedo.ubereats.providers.AuthProvider;
import com.abelsalcedo.ubereats.providers.GeofireProvider;
...
public class MapClienteActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private List<Marker> mColabMarkers = new ArrayList<>();
    ...
    private void getActiveDrivers() {
        mGeofireProvider.getActiveDelivery(mCurrentLatLng).addGeoQueryEventListener(new GeoQueryEventListener() {
            @Override
            public void onKeyEntered(String key, GeoLocation location) {
                // AÑADIREMOS LOS MARCADORES DE LOS COLABORADORES QUE SE CONECTEN EN LA APLICACION

                for (Marker marker: mColabMarkers) {
                ...
                Marker marker = mMap.addMarker(new MarkerOptions().position(driverLatLng).title("Emprendedor disponible").icon(BitmapDescriptorFactory.fromResource(R.drawable.icon_my_location)));
                marker.setTag(key);
                mColabMarkers.add(marker);
            }
            ...
            public void onKeyMoved(String key, GeoLocation location) {
                // ACTUALIZAR LA POSICION DE CADA COLABORADOR
                for (Marker marker: mColabMarkers) {
                    if (marker.getTag() != null) {
                        if (marker.getTag().equals(key)) {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (item.getItemId() == R.id.action_Pedir) {
            Intent intent = new Intent(MapClienteActivity.this, PedidosActivity.class);
